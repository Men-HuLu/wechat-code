...
}(require("../../lib/three")), f = require("../../config"), d = exports.Dpr = window.devicePixelRatio > 2 ? 2 : window.devicePixelRatio, g = (exports.realDpr = window.devicePixelRatio, 
exports.W = window.innerHeight < window.innerWidth ? window.innerHeight : window.innerWidth), w = exports.H = window.innerHeight > window.innerWidth ? window.innerHeight : window.innerWidth, x = exports.HEIGHT = w * d, m = exports.WIDTH = g * d, y = [ "btn", "list1", "list2", "bg" ], v = exports.CANVASTYPE = {
    friendRank: 0,
    groupRank: 1,
    gameOver: 2,
    start: 3,
    ...
    jiliProp: 23,
    msgDetail5: 24
}, h = exports.frustumSizeHeight = f.FRUSTUMSIZE, b = exports.frustumSizeWidth = m / x * h, T = exports.DEBUGVIEW = !1, I = !1, V = (exports.ListLineHeight = 60, 
