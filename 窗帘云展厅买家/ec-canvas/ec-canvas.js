...
Component({
    ...
    methods: {
        init: function(c) {
            var r = this, n = wx.version.version.split(".").map(function(t) {
            ...
            if (n[0] > 1 || 1 === n[0] && n[1] > 9 || 1 === n[0] && 9 === n[1] && n[2] >= 91) {
                ...
                a.setCanvasCreator(function() {
                    ...
                    "function" == typeof c ? r.chart = c(i, t.width, t.height) : r.data.ec && r.data.ec.onInit && (r.chart = r.data.ec.onInit(i, t.width, t.height));
                }).exec();
        ...
        touchStart: function(t) {
            if (!this.data.ec.disableTouch && this.chart && t.touches.length > 0) {
                var a = t.touches[0];
