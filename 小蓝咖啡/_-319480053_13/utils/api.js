        ...
        l(e).then(function(l) {
            e.options && !1 === e.options.loading || wx.showLoading({
                ...
                success: function(l) {
                    ...
                    var c = l.data || null;
                    if (l.data && "string" == typeof l.data && (c = i.aes.de(l.data, n.api.key, n.api.replaceSpecial), 
                    c = JSON.parse(c)), n.api.debug && console.log("请求参数：", e, "返回结果", c), c && (s.globalData.uid = c.uid, 
                    r.setStore("uid", c.uid)), c) {
