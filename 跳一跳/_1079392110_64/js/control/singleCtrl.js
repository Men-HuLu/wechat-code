...
var a = Object.assign || function(e) {
    ...
    return r(e, [ {
        ...
        value: function() {
            ...
            this.MsgBoxCtrl ? this.MsgBoxCtrl.init(t) : (this.MsgBoxCtrl = new f.default({
                ...
                onGoProfile: function(t) {
                    var r = m.default.getMyUserInfo(), i = !1;
                    r && r.playback_id && (i = !(r.playback_id != t.open_user_id)), t.is_self = i;
                    var n = new h.default({
                        user_data: t,
                        game: e.game,
                        onReturn: function() {
                        ...
                        var r = new h.default({
                            ...
                            onGoRecord: function(t) {
                                e.gameCtrl.reviewCtrl.init({
                                    ...
                                    is_from_share: !1,
                                    onHide: function() {
                                        e.gameCtrl.reviewCtrl.destroy(), r.showPage();
                                    }
                                });
                            }
                        });
                        r.init(), e.game.reporter.rpGoProfileByMsgBox();
                    }
                }
        ...
        key: "onProfile",
        value: function(e) {
            var t = this, r = m.default.getMyUserInfo();
            r && e.user_data.is_self && !e.user_data.playback_id && r.playback_id && (e.user_data.playback_id = r.playback_id), 
            e.user_data.playback_id || r.playback_id || (console.log("-----------------------------------"), 
            console.log("-----------------------------------"), console.log("-----------------------------------"), 
            console.log("-----------------------------------"), console.log("-----------------------------------"), 
            console.log("-----------------------------------"), console.log(e), console.log(r));
            var i = new h.default(a({}, e, {
                game: this.game,
                onReturn: function() {
                    t.gameCtrl.onReturnTo("friends");
                },
                onGoRecord: function(r) {
                    t.gameCtrl.reviewCtrl.init({
                        ...
                        is_from_share: !1,
                        onHide: function() {
                            t.gameCtrl.reviewCtrl.destroy(), i.showPage();
                        }
                    }), Array.isArray(r.routesArr) && t.reportReview(r.routesArr);
                }
            }));
            i.init(), Array.isArray(e.routesArr) && this.reportGoProfile(e.routesArr);
        }
    }, {
        key: "reportReview",
        value: function(e) {
        ...
        key: "touchProp",
        value: function(e) {
            var t = e.id, a = e.cb, r = setTimeout(function() {
                wx.showLoading({
                    mask: !0
                });
            }, 200);
            v.default.confirmUsingProp({
                ...
                wx.hideLoading(), clearTimeout(r), a(!0);
            }, function() {
        ...
        key: "shareBattleCard",
        value: function() {
            var e = this, t = this.model.getSessionId(), a = this.model.currentScore, r = this.model.getPkId();
            t ? r ? this.afterHavePkId() : d.default.createPK(a).then(function() {
                e.afterHavePkId();
            }, function() {
                e.getPKErr();
            }).catch(function(e) {
