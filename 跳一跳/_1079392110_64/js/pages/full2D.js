...
e(require("../scroll/scrollHandler")), e(require("../report")), require("./pages2d/base")), h = require("./pages2d/start"), l = require("./pages2d/beginner"), y = require("./pages2d/lookers"), c = require("./pages2d/pk"), u = require("./pages2d/rank"), p = require("./pages2d/gg"), d = require("./pages2d/verify"), v = require("./pages2d/relay"), T = require("./pages2d/record"), f = require("./pages2d/profile"), g = require("./pages2d/msg"), k = require("./pages2d/skin"), w = require("./pages2d/shareskin"), A = e(require("../lib/mue/eventcenter")), m = e(require("./headimgAnimation")), S = window.devicePixelRatio > 2 ? 2 : window.devicePixelRatio, E = window.innerHeight < window.innerWidth ? window.innerHeight : window.innerWidth, x = window.innerHeight > window.innerWidth ? window.innerHeight : window.innerWidth, _ = x * S, P = E * S, R = [ "btn", "list1", "list2", "bg" ], b = s.FRUSTUMSIZE, C = (wx.loadFont("res/num.ttf"), 
function() {
    function e(i) {
        var h = this;
